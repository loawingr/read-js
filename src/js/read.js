...
(function() {
    ...
    var readJS = {
        ...
        resetConfigStatus: function() {
            readJS.status = {
                ...
                activity: {
                    ...
                    totalTime: 0, //reset totalTime counters
                    initialTime: 0
                },
                thresholds: {
        ...
        */
        ...
        /*
             sets initial time for total time tracking
        */
        setInitialTime: function() {
            readJS.status.activity.initialTime = new Date().getTime();
            return readJS.status.activity.initialTime;
        },
        /*
            calculates total time since initial time was set
        */
        calculateTotalTime: function() {
            ...
            readJS.console("ERROR: readJS.calculateTotalTime() - initial time not set");
            return false;
        },
        ...
        */
        hasRead: function() {
            ...
            readJS.callback(readJS.calculateTotalTime());
